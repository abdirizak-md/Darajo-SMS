...
const Dashboard = () => {
  return (
    ...
    <div className='w-full h-screen bg-[#f5f7fa] p-8 transition-all duration-300 ease-in-out overflow-y-auto custom-scrollbar'>
    ...
    {/* chart and graphs */}
      ...
      {/* quicks action to do */}
      <div className="flex flex-col items-start mb-6 bg-white p-5">
        <h1 className='text-2xl mb-6 text-[#333] font-bold'>Quick Actions</h1>
        <div className='grid gap-5'>
          <div className="flex items-center gap-3 px-3 py-3 justify-center bg-[#e1e5e9] hover:bg-[#006b3f] hover:text-white rounded-md transition-all duration-200">
            <FaUserPlus />
